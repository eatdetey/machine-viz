...
#
#     open_noise = cv.erode(frame_noise, kernel, iterations=1)
#     open_noise = cv.dilate(open_noise, kernel, iterations=1)
#
#     close_noise = cv.dilate(frame_noise, kernel, iterations=1)
#     close_noise = cv.erode(frame_noise, kernel, iterations=1)
#
#     cv.imshow('Frame open', open_noise)
#     cv.imshow('Frame close', close_noise)
#
